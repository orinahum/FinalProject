...
public class ScreenRecorderMonte extends ScreenRecorder {
    ...
    public ScreenRecorderMonte(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat,
    ...
    public static void startRecord(String methodName) throws Exception {
        File file = new File(System.getProperty("user.dir") + "/ScreenRecorder/");
        ...
        screenRecorder = new ScreenRecorderMonte(gc, captureSize,
        ...
        System.out.println("Monte Screen Record Start");
    }

    public static void stopRecord() throws Exception {
        screenRecorder.stop();
        System.out.println("Monte Screen Record Stop");
    }
